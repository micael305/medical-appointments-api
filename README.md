...
> API REST para la gestión y reserva de citas médicas, construida con Node.js, Express, Prisma ORM 7 y PostgreSQL, containerizada con Docker y Nginx para despliegue en servidor VPS Ubuntu.

![Node.js](https://img.shields.io/badge/Node.js-v20-green?style=flat-square&logo=nodedotjs)
![Express.js](https://img.shields.io/badge/Express.js-v5-black?style=flat-square&logo=express)
![Prisma](https://img.shields.io/badge/Prisma_ORM-v7-2D3748?style=flat-square&logo=prisma)
...
Esta aplicación es una API REST desarrollada como proyecto práctico para la gestión de turnos y citas médicas. Permite registrar usuarios, gestionar franjas horarias y realizar reservas controlando la disponibilidad horaria y aplicando permisos según el rol del usuario (`ADMIN` / `USER`).

El proyecto incluye además un flujo completo de despliegue en producción para demostrar la containerización y orquestación de servicios en un servidor Linux (VPS).
